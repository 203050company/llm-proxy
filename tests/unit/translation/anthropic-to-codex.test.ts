...
describe("translateAnthropicToCodexRequest", () => {
  it("does not forward Anthropic max_tokens under its original field name", () => {
  ...
  describe("messages", () => {
    ...
    it("preserves image block data when it is already a data URL", () => {
      const result = translateAnthropicToCodexRequest(
        makeRequest({
          messages: [
            {
