...
describe("GET /v1/models with runtime API keys", () => {
  ...
  it("exposes total context and raw backend limits in model responses", async () => {
    ...
    const listed = listBody.data.find((m: { id: string }) => m.id === "gpt-5.5");
    expect(listed.context_window).toBe(400000);
    expect(listed.max_input_tokens).toBe(400000);
    expect(listed.input_context_window).toBe(272000);
    expect(listed.max_output_tokens).toBe(128000);
    expect(listed.max_tokens).toBe(128000);
    expect(listed.max_context_window).toBe(272000);

    const suffixedListed = listBody.data.find((m: { id: string }) => m.id === "gpt-5.5-xhigh");
    expect(suffixedListed.context_window).toBe(400000);
    expect(suffixedListed.max_input_tokens).toBe(400000);
    expect(suffixedListed.input_context_window).toBe(272000);
    expect(suffixedListed.max_output_tokens).toBe(128000);
    expect(suffixedListed.max_tokens).toBe(128000);

    const infoRes = await app.request("/v1/models/gpt-5.5/info");
    ...
    expect(infoBody.maxOutputTokens).toBe(128000);
    expect(infoBody.max_output_tokens).toBe(128000);
    expect(infoBody.max_tokens).toBe(128000);
    expect(infoBody.maxContextWindow).toBe(272000);
    expect(infoBody.max_context_window).toBe(272000);

    const suffixedModelRes = await app.request("/v1/models/gpt-5.5-xhigh");
    expect(suffixedModelRes.status).toBe(200);
    const suffixedModelBody = await suffixedModelRes.json();
    expect(suffixedModelBody.id).toBe("gpt-5.5-xhigh");
    expect(suffixedModelBody.context_window).toBe(400000);
    expect(suffixedModelBody.max_input_tokens).toBe(400000);
    expect(suffixedModelBody.input_context_window).toBe(272000);
    expect(suffixedModelBody.max_output_tokens).toBe(128000);
    expect(suffixedModelBody.max_tokens).toBe(128000);

    const suffixedInfoRes = await app.request("/v1/models/gpt-5.5-xhigh/info");
    expect(suffixedInfoRes.status).toBe(200);
    const suffixedInfoBody = await suffixedInfoRes.json();
    expect(suffixedInfoBody.id).toBe("gpt-5.5-xhigh");
    expect(suffixedInfoBody.contextWindow).toBe(400000);
    expect(suffixedInfoBody.context_window).toBe(400000);
    expect(suffixedInfoBody.max_input_tokens).toBe(400000);
    expect(suffixedInfoBody.inputContextWindow).toBe(272000);
    expect(suffixedInfoBody.input_context_window).toBe(272000);
    expect(suffixedInfoBody.maxOutputTokens).toBe(128000);
    expect(suffixedInfoBody.max_output_tokens).toBe(128000);
    expect(suffixedInfoBody.max_tokens).toBe(128000);
