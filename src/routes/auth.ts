...
export function createAuthRoutes(
  ...
  app.post("/auth/code-relay", async (c) => {
    ...
    try {
      ...
      const entryId = pool.addAccount(tokens.access_token, tokens.refresh_token, tokens.id_token);
  ...
  app.post("/auth/import-cli", async (c) => {
    try {
      ...
      const entryId = pool.addAccount(cliAuth.access_token!, cliAuth.refresh_token, cliAuth.id_token);
